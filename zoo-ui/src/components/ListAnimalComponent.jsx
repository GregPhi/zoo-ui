...
import WaintingComponent from './WaintingComponent';
...
class ListAnimalComponent extends Component {
    ...
    componentDidMount(){
        AnimalService.getAnimals().then((res) => {
            this.setState({ animals: res.data, loading : true});
        });
    }
                              ...
                              <tbody>
                                  {
                                      this.state.animals.map(
                                          animal =>
                                          <tr key = {animal.id}>
                                               <td> <img className="card-img-top" src={animal.picture} alt="Pictre"/> </td>
                                               <td> {animal.name} </td>
